...
def build_ksi():
    print("[NEXUS] Compilando KSI Engine (Kuramoto Synchronization Index)...")
    ...
    output_name = "ksi_engine.cp313-win_amd64.pyd"
    source_file = "src/ksi/ksi_engine.cpp"
    ...
    try:
        ...
        print(f"SUCCESS: KSI Engine compilado como {output_name}")
        ...
        print(f"FAIL: Erro na compilação do KSI: {e}")
