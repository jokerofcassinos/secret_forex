...
def build_gad():
    print("[NEXUS] Compilando GAD Engine (Gauge Arbitrage Detector)...")
    ...
    output_name = "gad_engine.cp313-win_amd64.pyd"
    source_file = "src/gad/gad_engine.cpp"
    ...
    try:
        ...
        print(f"SUCCESS: GAD Engine compilado como {output_name}")
        ...
        print(f"FAIL: Erro na compilação do GAD: {e}")
