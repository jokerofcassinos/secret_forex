...
if result.returncode == 0:
    ...
    shutil.copy2(output, os.path.join("bin", output))
    # Also copy to root for immediate use
    shutil.copy2(output, os.path.join("..", "..", output))
    print(f"Deployed to bin/ and root.")
else:
