...
def build_lbm():
    print("[NEXUS] Compilando LBM Engine (Navier-Stokes & Smagorinsky)...")
    ...
    output_name = "lbm_engine.cp313-win_amd64.pyd"
    source_file = "src/lbm/lbm_engine.cpp"
    ...
    try:
        ...
        print(f"SUCCESS: LBM Engine compilado como {output_name}")
        ...
        print(f"FAIL: Erro na compilação do LBM: {e}")
