...
def build_qte():
    print("[NEXUS] Compilando QTE Engine (Quantum Tunneling)...")
    ...
    output_name = "qte_engine.cp313-win_amd64.pyd"
    source_file = "src/qte/qte_engine.cpp"
    ...
    try:
        ...
        print(f"SUCCESS: QTE Engine compilado como {output_name}")
        ...
        print(f"FAIL: Erro na compilação do QTE: {e}")
