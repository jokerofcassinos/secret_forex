...
def build_qgc():
    print("[NEXUS] Compilando QGC Engine (Gravity & Condensates)...")
    ...
    output_name = "qgc_engine.cp313-win_amd64.pyd"
    source_file = "src/qgc/qgc_engine.cpp"
    ...
    try:
        ...
        print(f"SUCCESS: QGC Engine compilado como {output_name}")
        ...
        print(f"FAIL: Erro na compilação do QGC: {e}")
